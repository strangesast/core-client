...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div class="controls">
        <div
          [matTooltip]="
            form.invalid ? 'Items above need to be fixed.' : 'Login to account.'
          "
  ...
  `,
  styleUrls: ['../../styles/login-base.scss', './login-page.component.scss'],
})
        ...
        exhaustMap((payload) =>
          this.service
            ...
            .pipe(
              timeoutWith(
                4000,
                throwError(new Error('Could not reach server.'))
              ),
              exhaustMap(() => {
                this.loading = false;
                this.complete = true;
