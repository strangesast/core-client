    ...
    <mat-table [dataSource]="dataSource" matSort>
      <ng-container matColumnDef="employee.name">
        ...
        <mat-cell *matCellDef="let cell"
          ><a [routerLink]="['/people', cell.employee.id]">
            {{ cell.employee.first_name }} {{ cell.employee.last_name }}</a
          ></mat-cell
        >
      </ng-container>
      <ng-container matColumnDef="start">
        ...
        <mat-cell *matCellDef="let cell">
          {{ cell.date_start | date: 'shortTime' }}
        </mat-cell>
      </ng-container>
      ...
      <ng-container matColumnDef="duration">
        ...
        <mat-cell *matCellDef="let cell">
          {{ cell.duration | async | duration: 'h:mm:ss' }}
        </mat-cell>
      </ng-container>
      <!--
