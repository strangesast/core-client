...
@Component({
  ...
  template: `
    <app-page-title>
      ...
      <a [routerLink]="['/orders', 'historical']">List</a>
    </app-page-title>
    <header>
    ...
    -->
      <mat-chip-list>
        <mat-chip
          *ngFor="let param of paramsList$ | async"
          [removable]="true"
    ...
    <div class="table-container">
      <mat-table [dataSource]="dataSource" matSort>
        ...
        <ng-container matColumnDef="part" sticky>
          ...
          <mat-cell *matCellDef="let cell"
            ><a
              [routerLink]="['/orders', 'historical']"
              [queryParams]="{ part: cell.part }"
            >
              {{ cell.part }}
            </a></mat-cell
          >
        ...
        <ng-container matColumnDef="customer">
          ...
          <mat-cell *matCellDef="let cell"
            ><a [routerLink]="['/customers', cell.customer]">
              {{ cell.customer }}
            </a></mat-cell
          >
        </ng-container>
  ...
  `,
  styleUrls: ['../../styles/base.scss', './order-list-page.component.scss'],
})
export class OrderListPageComponent implements OnInit, OnDestroy {
  ...
  paramsList$ = this.params$.pipe(
    map((q) => Object.entries(q).map(([key, value]) => ({ key, value })))
  );

  query$ = this.params$.pipe(
    switchMap((q) => this.apollo.query(buildQuery(q))),
    pluck('data')
  );
