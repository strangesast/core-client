...
import { ControlValueAccessor, FormBuilder, Validators, NG_VALUE_ACCESSOR } from '@angular/forms';
...
export class CustomerFormComponent implements OnInit, OnDestroy, ControlValueAccessor {
  form = this.fb.group({
    id: [''],
  ...
  registerOnChange(fn) {
    ...
    this.sub = this.form.valueChanges.pipe().subscribe(value => this.onChange(value));
  }
