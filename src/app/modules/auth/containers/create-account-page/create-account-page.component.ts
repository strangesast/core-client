...
import { sameValueValidator } from '../../../../util/validators';
    ...
    <form [formGroup]="form" (submit)="submit$.next()">
      ...
      <ng-container formGroupName="name">
        <mat-form-field appearance="outline">
          ...
          />
          <mat-error *ngIf="hasError('name.first', 'required')"
      ...
      <mat-form-field appearance="outline">
        ...
        <input
          ...
          appPropertyValidator="username"
        />
        <mat-hint
          *ngIf="
            form.controls['username'].valid &&
            !form.controls['username'].pending
          "
          >Username is available.</mat-hint
        >
        <mat-error *ngIf="hasError('username', 'custom')"
      ...
      <mat-form-field appearance="outline">
        ...
        <input
          ...
          appPropertyValidator="email"
        />
        <mat-error *ngIf="hasError('email', 'email')"
          >Email is invalid.</mat-error
        >
        <mat-error *ngIf="hasError('email', 'custom')"
          >Email is not available.</mat-error
        >
      </mat-form-field>
      <mat-form-field appearance="outline">
      ...
      <mat-form-field appearance="outline">
        ...
        <input
          matInput
          placeholder="password_verify"
          type="password"
          formControlName="passwordVerify"
        />
        <mat-error *ngIf="hasError('passwordVerify', 'sameValue')"
      ...
      <div class="controls">
        <div
          [matTooltip]="
            form.invalid ? 'Items above need to be fixed' : 'Create account'
          "
        ...
        <a mat-button queryParamsHandling="preserve" [routerLink]="['/login']"
